...
const mockProject = {
  ...
  description:
    "Full-featured online store with payment processing, admin dashboard, and user accounts.",
  image: "https://images.unsplash.com/photo-1556740714-a8395b3a74dd?w=800",
  steps: [
    {
      ...
      content: {
        engineering:
          "<p>Stripe Checkout + Payment Intents API. Webhook handling for order confirmation.</p>",
      },
      images: [],
    },
    {
      id: "696666ca375b657eaabe0ed1",
      title: "Admin Dashboard 123",
      icon: "📊",
      content: {
        engineering:
          "<p>Protected routes with role-based access. Recharts for analytics visualization.</p>",
      },
      images: [],
    },
  ],
